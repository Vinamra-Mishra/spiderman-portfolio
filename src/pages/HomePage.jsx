...
export default function HomePage({ isSpiderSense, playWebSound }) {
  ...
  return (
    <div className="animate-fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
      ...
      <div className="spider-card" style={{ minHeight: '65vh', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
        ...
        <div>
          ...
          <p style={{ fontSize: '1.25rem', color: '#D1D5DB', maxWidth: '700px', lineHeight: '1.6', marginBottom: '2.5rem', fontWeight: '400' }}>
            Engineering ultra-fast web applications, autonomous AI agent systems, and computer vision pipelines with speed and spider precision.
          </p>
        ...
        <div style={{ display: 'flex', gap: '3rem', flexWrap: 'wrap', borderTop: '1px solid var(--card-border)', paddingTop: '1.5rem', marginTop: '2rem' }}>
          <div>
